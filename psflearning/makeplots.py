...
def showpupil(f,p, index=None):
    if p.channeltype == 'single':
        ...
        plt.imshow(np.angle(pupil),cmap='twilight_shifted',interpolation='nearest')
        ...
        for i in range(0,Nchannel):
            ...
            h=ax.imshow(pupil_mag,cmap='twilight_shifted',interpolation='nearest')
            ax.axis('off')
            ax.set_title('pupil magnitude ' + str(i))
            fig.colorbar(h,ax=ax)
            ax1 = fig1.add_subplot(1,Nchannel,i+1)
            pupil_phase = np.angle(pupil)
            h1=ax1.imshow(pupil_phase,cmap='twilight_shifted',interpolation='nearest')
            ax1.axis('off')
        ...
        for i in range(0,Nchannel):
            ...
            plt.imshow(pupil_mag,cmap='twilight_shifted',interpolation='nearest')
            plt.axis('off')
        ...
        for i in range(0,Nchannel):
            ...
            plt.imshow(pupil_phase,cmap='twilight_shifted',interpolation='nearest')
            plt.axis('off')

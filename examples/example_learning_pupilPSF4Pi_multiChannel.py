...
for i in range(0,Nchannel):
    ...
    pupil_phase = np.sum(Zk[4:]*res_dict['channel'+str(i)]['zernike_coeff_phase'][0][4:].reshape((-1,1,1)),axis=0)*aperture
    plt.imshow(pupil_phase,cmap='bwr')
    plt.axis('off')
    ax = fig.add_subplot(2,4,i+5)
    pupil_phase = np.sum(Zk[4:]*res_dict['channel'+str(i)]['zernike_coeff_phase'][1][4:].reshape((-1,1,1)),axis=0)*aperture
    plt.imshow(pupil_phase,cmap='bwr')
    plt.axis('off')
plt.show()
...
for i in range(0,Nchannel):
    ax = fig.add_subplot(2,4,i+1)
    pupil_mag = np.sum(Zk*res_dict['channel'+str(i)]['zernike_coeff_mag'][0].reshape((-1,1,1)),axis=0)*aperture
    plt.imshow(pupil_mag,cmap='bwr')
    plt.axis('off')
    ax = fig.add_subplot(2,4,i+5)
    pupil_mag = np.sum(Zk*res_dict['channel'+str(i)]['zernike_coeff_mag'][1].reshape((-1,1,1)),axis=0)*aperture
    plt.imshow(pupil_mag,cmap='bwr')
    plt.axis('off')
plt.show()
...
for i in range(0,Nchannel):
    ax = fig.add_subplot(2,4,i+1)
    pupil_phase = np.angle(res_dict['channel'+str(i)]['pupil1'])*aperture
    plt.imshow(pupil_phase,cmap='bwr')
    plt.axis('off')
    ax = fig.add_subplot(2,4,i+5)
    pupil_phase = np.angle(res_dict['channel'+str(i)]['pupil2'])*aperture
    plt.imshow(pupil_phase,cmap='bwr')
    plt.axis('off')
plt.show()
...
for i in range(0,Nchannel):
    ax = fig.add_subplot(2,4,i+1)
    pupil_mag = np.abs(res_dict['channel'+str(i)]['pupil1'])*aperture
    plt.imshow(pupil_mag,cmap='bwr',vmax=1.3,vmin=0.0)
    plt.axis('off')
    ax = fig.add_subplot(2,4,i+5)
    pupil_mag = np.abs(res_dict['channel'+str(i)]['pupil2'])*aperture
    plt.imshow(pupil_mag,cmap='bwr',vmax=1.3,vmin=0.0)
    plt.axis('off')
plt.show()
# %%
...
for i in range(0,Nchannel):
    ...
    ax1.plot(res_dict['channel'+str(i)]['zernike_coeff_mag'][0],'.-')    
    ax2.plot(res_dict['channel'+str(i)]['zernike_coeff_phase'][0],'.-')
    ax2.set_ylim((-0.6,0.6))
    ax3.plot(res_dict['channel'+str(i)]['zernike_coeff_mag'][1],'.-')
    ax4.plot(res_dict['channel'+str(i)]['zernike_coeff_phase'][1],'.-')
